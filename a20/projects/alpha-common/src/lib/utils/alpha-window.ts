/**
 * Utility class for browser-related information and viewport analysis.
 *
 * Provides static getters for:
 * - navigatorLanguageCode: Retrieves the user's browser language code (2-letter, lowercase).
 * - mediaWidth: Returns the current viewport width category ('xs', 'sm', 'md', 'lg', 'xl').
 *
