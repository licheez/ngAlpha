/**
 * Utility class for string, number, and binary operations.
 *
 * Provides static methods for:
 * - String checks (null/empty, contains)
 * - Null/undefined checks
 * - Number conversion and rounding
 * - Currency formatting
 * - Base64, Blob, and Uint8Array conversions
 * - Data URL utilities
 *
